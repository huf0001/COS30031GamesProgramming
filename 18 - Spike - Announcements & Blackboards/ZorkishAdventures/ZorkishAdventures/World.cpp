		...
		while (std::getline(ifs, line))
		{
			...
			else if (splitLine[0] == "L")
			{
				...
				else
				{
					...
					MessageManager::Instance()->Subscribe((GameObject*)locations[splitLine[1]]);
				}
			}
			else if (splitLine[0] == "P")
			{
				...
				else
				{
					...
					MessageManager::Instance()->Subscribe((GameObject*)path);
				}
			}
			...
			{	
				...
				{	
					...
					MessageManager::Instance()->Subscribe((GameObject*)item);
